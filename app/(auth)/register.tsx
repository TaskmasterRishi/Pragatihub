...
export default function RegisterScreen() {
  ...
  const nameFocusScale = useSharedValue(1);
  const emailFocusScale = useSharedValue(1);
  const passwordFocusScale = useSharedValue(1);
  const confirmPasswordFocusScale = useSharedValue(1);
  ...
  const nameAnimatedStyle = useAnimatedStyle(() => ({
    transform: [{ scale: nameFocusScale.value }],
  ...
  const confirmPasswordAnimatedStyle = useAnimatedStyle(() => ({
    transform: [{ scale: confirmPasswordFocusScale.value }],
    borderColor: interpolateColor(
  ...
  const handleNameFocus = () => {
    nameFocusScale.value = withSpring(1.02, { damping: 15, stiffness: 200 });
    nameFocused.value = withSpring(1, { damping: 15, stiffness: 200 });
  };

  const handleNameBlur = () => {
    nameFocusScale.value = withSpring(1, { damping: 15, stiffness: 200 });
    nameFocused.value = withSpring(0, { damping: 15, stiffness: 200 });
  };
  ...
  const handleConfirmPasswordFocus = () => {
    confirmPasswordFocusScale.value = withSpring(1.02, { damping: 15, stiffness: 200 });
    confirmPasswordFocused.value = withSpring(1, { damping: 15, stiffness: 200 });
  };

  const handleConfirmPasswordBlur = () => {
    confirmPasswordFocusScale.value = withSpring(1, { damping: 15, stiffness: 200 });
    confirmPasswordFocused.value = withSpring(0, { damping: 15, stiffness: 200 });
  };
